...
class TestSemiresolvedSSPSynthesizer:
    ...
    def test_synthesize_out_masses_option(self, synthesizer, prng_key, small_num_stars):
        ...
        assert isinstance(masses, jnp.ndarray), (
            'Should return array of masses when out_masses=True'
        )
        assert masses.shape[0] == small_num_stars, (
            f'Should have {small_num_stars} stellar masses'
        )
