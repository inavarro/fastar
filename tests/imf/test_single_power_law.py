...
from fastar.imf.named_imf.single_power_law import (
    single_power_law_raw,
    single_power_law,
)
...
class TestSinglePowerLawIMF:
    ...
    def test_different_alpha_values(self, mass_array):
        ...
        assert not bool(jnp.allclose(imf1, imf2)), (
            'Different alphas should produce different IMFs'
        )
