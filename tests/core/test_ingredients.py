"""
Tests for population ingredients functionality.
"""
import pytest
...
class TestPopulationIngredients:
    ...
    def test_filter_response_loaded(self, pop_ingredients):
        ...
        assert hasattr(pop_ingredients, 'filter_response'), "Should have filter response"
        assert len(pop_ingredients.filter_response) > 0, "Filter response should not be empty"
